...
$mounth = ['0', 'январь', 'февраль', 'март', 'апрель', 'май', 'июнь', 'июль', 'август', 'сентябрь', 'октябрь', 'ноябрь', 'декабрь'];
...
?>
        ...
        <tr><td rowspan="2">Месяц</td><td colspan="2">Теплоснабжение</td><td colspan="2">Водоотведение</td><td colspan="2">Негативка</td><td colspan="2">Водоснабжение</td><td colspan="2">Электроснабжение</td><td colspan="2">Вывоз мусора</td><td colspan="2">Утилизация ТБО</td><td  rowspan="2">ИТОГ_(руб.)</td></tr>

        <tr><td>Объем</td><td>Сумма_(руб.)</td><td>Объем</td><td>Сумма_(руб.)</td><td>Объем</td><td>Сумма_(руб.)</td><td>Объем</td><td>Сумма_(руб.)</td><td>Объем</td><td>Сумма_(руб.)</td><td>Объем</td><td>Сумма_(руб.)</td><td>Объем</td><td>Сумма_(руб.)</td></tr>
        
        <?php foreach ($pageData['info'] as $key => $value) {
            ...
            if ($value['status'] == 2) {
                ...
                HTML;
                /*
                echo "<td><input type=text id='user' class='volume1' value=" . $value['volume1'] ."></td>";
                echo "<td><input type=text id='user' class='sum1' value=" . $value['sum1'] ."></td>";
                echo "<td><input type=text id='user' class='volume2' value=" . $value['volume2'] ."></td>";
                echo "<td><input type=text id='user' class='sum2' value=" . $value['sum2'] ."></td>";
                echo "<td><input type=text id='user' class='volume3' value=" . $value['volume3'] ."></td>";
                echo "<td><input type=text id='user' class='sum3' value=" . $value['sum3'] ."></td>";
                echo "<td><input type=text id='user' class='volume4' value=" . $value['volume4'] ."></td>";
                echo "<td><input type=text id='user' class='sum4' value=" . $value['sum4'] ."></td>";
                echo "<td><input type=text id='user' class='volume5' value=" . $value['volume5'] ."></td>";
                echo "<td><input type=text id='user' class='sum5' value=" . $value['sum5'] ."></td>";
                echo "<td><input type=text id='user' class='volume6' value=" . $value['volume6'] ."></td>";
                echo "<td><input type=text id='user' class='sum6' value=" . $value['sum6'] ."></td>";
                echo "<td><input type=text id='user' class='volume7' value=" . $value['volume7'] ."></td>";
                echo "<td><input type=text id='user' class='sum7' value=" . $value['sum7'] ."></td>";
   ...
   <p><input type="button" name="formSubmit" id="btn3" class="btn" value="Таблица" /></p>
        ...
        $moun = ['0', 'январь', 'февраль', 'март', 'апрель', 'май', 'июнь', 'июль', 'август', 'сентябрь', 'октябрь', 'ноябрь', 'декабрь'];
