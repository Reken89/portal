...
Route::get('/delo/npa/table', [DeloNpaController::class, 'ShowTable'])->middleware('auth');
Route::post('/delo/npa/add', [DeloController::class, 'AddNpa'])->middleware('auth');
...
Route::get('/delo/npa', [DeloNpaController::class, 'FrontView'])->middleware('auth');
