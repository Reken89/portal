<table>
    <thead>
        <tr>
            ...
            <th style="min-width: 150px; width: 150px;">0103 Расходы совета</th>
            ...
            <th style="min-width: 150px; width: 150px;">0106 Расходы КСО</th>
            ...
            <th style="min-width: 150px; width: 150px;">ФЭУ 0103 Расходы совета</th>
            ...
            <th style="min-width: 150px; width: 150px;">ФЭУ 0106 Расходы КСО</th>
            ...
            <th style="min-width: 150px; width: 150px;">ФЭУ 0502 Коммунальное хозяйство</th>
            ...
            <th style="min-width: 150px; width: 150px;">ФЭУ 0314 Другие вопросы</th>
            <th style="min-width: 150px; width: 150px;">ФЭУ 0501 Жилищное хозяйство</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($info['budget'] as $value) 
            ...
            <tr>
                ...
                <td><b>{{ $value['data'][77]['sum_cb'] }}</b></td>
                <td><b>{{ $value['data'][53]['sum_cb'] }}</b></td>
                <td><b>{{ $value['data'][54]['sum_cb'] }}</b></td>
                <td><b>{{ $value['data'][78]['sum_cb'] }}</b></td>
                ...
                <td><b>{{ $value['data'][77]['sum_fu'] }}</b></td>
                <td><b>{{ $value['data'][53]['sum_fu'] }}</b></td>
                <td><b>{{ $value['data'][54]['sum_fu'] }}</b></td>
                <td><b>{{ $value['data'][78]['sum_fu'] }}</b></td>
            ...
            <tr>
                ...
                <td>{{ $displayEkr }}</td> 
                <td>{{ $value['data'][77]['sum_cb'] }}</td>
                <td>{{ $value['data'][53]['sum_cb'] }}</td>
                <td>{{ $value['data'][54]['sum_cb'] }}</td>
                <td>{{ $value['data'][78]['sum_cb'] }}</td>
                ...
                <td>{{ $value['data'][77]['sum_fu'] }}</td>
                <td>{{ $value['data'][53]['sum_fu'] }}</td>
                <td>{{ $value['data'][54]['sum_fu'] }}</td>
                <td>{{ $value['data'][78]['sum_fu'] }}</td>
        ...
        <tr>
            <td><b>Итог</b></td>
            <td></td>
            <td><b>{{ $info['total'][77]['sum_cb'] }}</b></td>
            <td><b>{{ $info['total'][53]['sum_cb'] }}</b></td>
            <td><b>{{ $info['total'][54]['sum_cb'] }}</b></td>
            <td><b>{{ $info['total'][78]['sum_cb'] }}</b></td>
            ...
            <td><b>{{ $info['total'][77]['sum_fu'] }}</b></td>
            <td><b>{{ $info['total'][53]['sum_fu'] }}</b></td>
            <td><b>{{ $info['total'][54]['sum_fu'] }}</b></td>
            <td><b>{{ $info['total'][78]['sum_fu'] }}</b></td>
