    ...
    <tbody>
        @foreach ($info['budget'] as $value) 
            ...
            <tr>
                ...
                <td><b>{{ number_format($value['data'][78]['sum_fu'], 2, ',', ' ') }}</b></td>
                ...
                <td><font color="blue"><b>{{ number_format($value['data'][77]['sum_cb'], 2, ',', ' ') }}</b></td>
                ...
                <td><font color="blue"><b>{{ number_format($value['data'][78]['sum_cb'], 2, ',', ' ') }}</b></td>
            ...
            <tr data-id="{{ $value['id'] }}" data-year="{{ $value['year'] }}">
                ...
                @if ($info['structure'] == "close")
                    ...
                    <td>{{ number_format($value['data'][78]['sum_fu'], 2, ',', ' ') }}</td>
                ...
                @else
                    <td data-user-id="77">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][77]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="53">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][53]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="54">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][54]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="78">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][78]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="55">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][55]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="56">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][56]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="57">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][57]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="58">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][58]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="59">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][59]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="60">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][60]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="61">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][61]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="62">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][62]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="63">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][63]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="64">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][64]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="65">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][65]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="66">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][66]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="67">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][67]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="68">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][68]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="73">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][73]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                    <td data-user-id="74">
                        <span class="sum-editable" contenteditable="true">
                            {{ number_format($value['data'][74]['sum_fu'], 2, ',', ' ') }}
                        </span>
                    </td>
                @endif
                
                <td><font color="blue">{{ number_format($value['data'][77]['sum_cb'], 2, ',', ' ') }}</td>
                <td><font color="blue">{{ number_format($value['data'][53]['sum_cb'], 2, ',', ' ') }}</td>
                <td><font color="blue">{{ number_format($value['data'][54]['sum_cb'], 2, ',', ' ') }}</td>
                <td><font color="blue">{{ number_format($value['data'][78]['sum_cb'], 2, ',', ' ') }}</td>
        ...
        <tr>
            ...
            <td></td>
            <td><b>{{ number_format($info['total'][77]['sum_fu'], 2, ',', ' ') }}</b></td>
            <td><b>{{ number_format($info['total'][53]['sum_fu'], 2, ',', ' ') }}</b></td>
            <td><b>{{ number_format($info['total'][54]['sum_fu'], 2, ',', ' ') }}</b></td>
            <td><b>{{ number_format($info['total'][78]['sum_fu'], 2, ',', ' ') }}</b></td>
            ...
            <td><font color="blue"><b>{{ number_format($info['total'][77]['sum_cb'], 2, ',', ' ') }}</b></td>
            ...
            <td><font color="blue"><b>{{ number_format($info['total'][78]['sum_cb'], 2, ',', ' ') }}</b></td>
