            ...
            <div class="container-fluid px-md-4	">
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="/portal/public/ofs/admin" class="nav-link">ОФС</a></li>
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-end justify-content-start">
                    <div class="col-md-12 ftco-animate text-center mb-5">
                        ...
                        <h1 class="mb-3 bread">ОФС (синхронизация)</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div style="background-color: PaleTurquoise;" class="container">
                <div class="row"> 
                    <div class="col-md-12 col-lg-8 mb-5">         
                        <form id="parameters" method="get" class="p-5 bg-white">
                            
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <label class="font-weight-bold" for="fullname">Месяца</label>
                                    <div class="form-group">
                                        <div class="form-field">
                                            <div class="select-wrap">
                                                <select name="mounth" class="form-control">
                                                    <option value="1">январь => февраль</option>
                                                    <option value="2">февраль => март</option>
                                                    <option value="3">март => апрель</option>
                                                    <option value="4">апрель => май</option>
                                                    <option value="5">май => июнь</option>
                                                    <option value="6">июнь => июль</option>
                                                    <option value="7">июль => август</option>
                                                    <option value="8">август => сентябрь</option>
                                                    <option value="9">сентябрь => октябрь</option>
                                                    <option value="10">октябрь => ноябрь</option>
                                                    <option value="11">ноябрь => декабрь</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <div id="block">
                                        <button class="btn btn-primary  py-2 px-5" id='synch' type="button">Синхронизация</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-lg-4">
                        <div class="p-4 mb-3 bg-white">
                            ...
                            <p class="mb-0 font-weight-bold"><font color="red">Выполнение синхронизации между месяцами</p>                            
                        </div>   
                    </div>     
