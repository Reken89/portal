                ...
                <div class="row">      
                    <div class="col-md-12 col-lg-8 mb-5">         
                        <form action="/portal/public/archive/admin/export" id="parameters" method="get" class="p-5 bg-white">
                                    ...
                                    <div class="form-group">
                                        <div class="form-field">
                                            <div class="checkselect">                                                
                                                ...
                                                <label><input type="checkbox" name="user[]" value="11">МКДОУ "Гномик"</label>
                                                <label><input type="checkbox" name="user[]" value="14">МКДОУ "Сказка"</label>                                                
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <button class="btn btn-primary  py-2 px-5" id='btn_add' type="submit">XLSX</button>
                                </div>
                            </div>
                        </form>
                    </div>                  
                    ...
                    <div class="col-lg-4">
                        <div class="p-4 mb-3 bg-white">
                            ...
                            <p class="mb-0 font-weight-bold"><font color="red">Выберите необходимые параметры и нажмите кнопку «XLSX».</p>
                        </div>   
                    </div>                    
